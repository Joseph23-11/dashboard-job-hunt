          ...
          <div>
            ...
            <div className="text-gray-500 mt-3">
              <p>
                ...
                quo assumenda quos magni perspiciatis eveniet similique rerum
                error animi sapiente. Consequatur quisquam ipsum ut ipsa veniam
                obcaecati voluptates delectus aut.
              </p>
            </div>
          </div>
          <div>
        ...
        <div className="grid grid-cols-4 gap-5 mt-9">
          {[0, 1, 2].map((item: number) => (
            <div key={item}>
              ...
              <div className="text-lg font-semibold mb-3">Full Heathcare</div>
              <div className="text-gray-500">
